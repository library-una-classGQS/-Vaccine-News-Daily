...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('usuario', schema=None) as batch_op:
        batch_op.add_column(sa.Column('_email', mysql.VARCHAR(length=20), nullable=False))
        batch_op.add_column(sa.Column('usuario', mysql.VARCHAR(length=20), nullable=False))
